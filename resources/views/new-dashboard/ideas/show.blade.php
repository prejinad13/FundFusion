...
@section('content')
    ...
    <h4 class="text-right py-3 mb-4">
        <span class="text-muted fw-light"> {{$data['data']->name}} /</span> View / {{$_panel}}
    </h4>
                    ...
                    <div class="card academy-content shadow-none border">
                        <div class="p-2">
                            <div class="cursor-pointer">
                                ...
                                @endphp
                                <iframe class="w-100" height="400" src="{{ $videoUrl }}" title="{{ $data['data']->name }}"
                                    frameborder="0"
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    @foreach ($data['data']->sectors as $sector)
                        <span class="badge rounded-pill bg-label-primary mb-2"><i class="{{$sector->icon}}"> </i>
                            {{$sector->name}}</span>
                    @endforeach
                    <div class="mb-4"></div>
